...
tt_df1 <-  gsg6cov %>% replace_with_na(replace = list(pos_csp = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_csp_test=tt_df1$pos_csp)

tt_df1 <-  gsg6cov %>% replace_with_na(replace = list(pos_pcr = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_pcr_test=tt_df1$pos_pcr)
...
stack_CSP_test <- inla.stack(
  data = list(y = cbind(NA, as.vector(gsg6cov$pos_csp_test), NA, NA, NA)),
  A = list(A,diag(N)), 
...
stack_PCR_test <- inla.stack(
  data = list(y = cbind(NA, NA, NA, as.vector(gsg6cov$pos_pcr_test), NA)),
  A = list(A,diag(N)), 
...
tt_df2 <-  gsg6cov %>% replace_with_na(replace = list(pos_csp = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_csp_test=tt_df2$pos_csp)

tt_df2 <-  gsg6cov %>% replace_with_na(replace = list(pos_pcr = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_pcr_test=tt_df2$pos_pcr)
...
tt_df3 <-  gsg6cov %>% replace_with_na(replace = list(pos_csp = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_csp_test=tt_df3$pos_csp)

tt_df3 <-  gsg6cov %>% replace_with_na(replace = list(pos_pcr = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_pcr_test=tt_df3$pos_pcr)
...
tt_df4 <-  gsg6cov %>% replace_with_na(replace = list(pos_csp = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_csp_test=tt_df4$pos_csp)

tt_df4 <-  gsg6cov %>% replace_with_na(replace = list(pos_pcr = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_pcr_test=tt_df4$pos_pcr)
...
tt_df5 <-  gsg6cov %>% replace_with_na(replace = list(pos_csp = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_csp_test=tt_df5$pos_csp)

tt_df5 <-  gsg6cov %>% replace_with_na(replace = list(pos_pcr = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_pcr_test=tt_df5$pos_pcr)
...
tt_df6 <-  gsg6cov %>% replace_with_na(replace = list(pos_csp = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_csp_test=tt_df6$pos_csp)

tt_df6 <-  gsg6cov %>% replace_with_na(replace = list(pos_pcr = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_pcr_test=tt_df6$pos_pcr)
...
tt_df7 <-  gsg6cov %>% replace_with_na(replace = list(pos_csp = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_csp_test=tt_df7$pos_csp)

tt_df7 <-  gsg6cov %>% replace_with_na(replace = list(pos_pcr = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_pcr_test=tt_df7$pos_pcr)
...
tt_df8 <-  gsg6cov %>% replace_with_na(replace = list(pos_csp = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_csp_test=tt_df8$pos_csp)

tt_df8 <-  gsg6cov %>% replace_with_na(replace = list(pos_pcr = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_pcr_test=tt_df8$pos_pcr)
...
tt_df9 <-  gsg6cov %>% replace_with_na(replace = list(pos_csp = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_csp_test=tt_df9$pos_csp)

tt_df9 <-  gsg6cov %>% replace_with_na(replace = list(pos_pcr = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_pcr_test=tt_df9$pos_pcr)
...
tt_df100 <-  gsg6cov %>% replace_with_na(replace = list(pos_csp = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_csp_test=tt_df10$pos_csp)

tt_df10 <-  gsg6cov %>% replace_with_na(replace = list(pos_pcr = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_pcr_test=tt_df10$pos_pcr)
...
tt_df11 <-  gsg6cov %>% replace_with_na(replace = list(pos_csp = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_csp_test=tt_df11$pos_csp)

tt_df11 <-  gsg6cov %>% replace_with_na(replace = list(pos_pcr = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_pcr_test=tt_df11$pos_pcr)
...
tt_df122 <-  gsg6cov %>% replace_with_na(replace = list(pos_csp = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_csp_test=tt_df12$pos_csp)

tt_df12 <-  gsg6cov %>% replace_with_na(replace = list(pos_pcr = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_pcr_test=tt_df12$pos_pcr)
...
tt_df13 <-  gsg6cov %>% replace_with_na(replace = list(pos_csp = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_csp_test=tt_df13$pos_csp)

tt_df13 <-  gsg6cov %>% replace_with_na(replace = list(pos_pcr = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_pcr_test=tt_df13$pos_pcr)
...
tt_df14 <-  gsg6cov %>% replace_with_na(replace = list(pos_csp = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_csp_test=tt_df14$pos_csp)

tt_df14 <-  gsg6cov %>% replace_with_na(replace = list(pos_pcr = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_pcr_test=tt_df14$pos_pcr)
...
tt_df15 <-  gsg6cov %>% replace_with_na(replace = list(pos_csp = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_csp_test=tt_df15$pos_csp)

tt_df15 <-  gsg6cov %>% replace_with_na(replace = list(pos_pcr = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_pcr_test=tt_df15$pos_pcr)
...
tt_df16 <-  gsg6cov %>% replace_with_na(replace = list(pos_csp = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_csp_test=tt_df16$pos_csp)

tt_df16 <-  gsg6cov %>% replace_with_na(replace = list(pos_pcr = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_pcr_test=tt_df16$pos_pcr)
...
tt_df17 <-  gsg6cov %>% replace_with_na(replace = list(pos_csp = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_csp_test=tt_df17$pos_csp)

tt_df17 <-  gsg6cov %>% replace_with_na(replace = list(pos_pcr = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_pcr_test=tt_df17$pos_pcr)
...
tt_df18 <-  gsg6cov %>% replace_with_na(replace = list(pos_csp = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_csp_test=tt_df18$pos_csp)

tt_df18 <-  gsg6cov %>% replace_with_na(replace = list(pos_pcr = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_pcr_test=tt_df18$pos_pcr)
...
tt_df19 <-  gsg6cov %>% replace_with_na(replace = list(pos_csp = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_csp_test=tt_df19$pos_csp)

tt_df19 <-  gsg6cov %>% replace_with_na(replace = list(pos_pcr = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_pcr_test=tt_df19$pos_pcr)
...
tt_df20 <-  gsg6cov %>% replace_with_na(replace = list(pos_csp = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_csp_test=tt_df20$pos_csp)

tt_df20 <-  gsg6cov %>% replace_with_na(replace = list(pos_pcr = test_ind) )
gsg6cov <- cbind(gsg6cov,pos_pcr_test=tt_df20$pos_pcr)
...
ggsave(
  filename = "H://Documents/test data/03 Output/gsg6_csp_pcr/predVobs_gsg6allna.png",
  plot = last_plot(),
  device = NULL,
  scale = 1,
  width = 20,
...
ggsave(
  filename = "H://Documents/test data/03 Output/gsg6_csp_pcr/predVobs_cspallna.png",
  plot = last_plot(),
  device = NULL,
  scale = 1,
  width = 20,
...
ggsave(
  filename = "H://Documents/test data/03 Output/gsg6_csp_pcr/predVobs_pcrallna.png",
  plot = last_plot(),
  device = NULL,
  scale = 1,
  width = 20,
...
ggsave(
  filename = "H://Documents/test data/03 Output/gsg6_csp_pcr/predVobs_gsg6_prev_allna.png",
  plot = last_plot(),
  device = NULL,
  scale = 1,
  width = 20,
...
ggsave(
  filename = "H://Documents/test data/03 Output/gsg6_csp_pcr/predVobs_csp_prev_allna.png",
  plot = last_plot(),
  device = NULL,
  scale = 1,
  width = 20,
...
ggsave(
  filename = "H://Documents/test data/03 Output/gsg6_csp_pcr/predVobs_pcr_prev_allna.png",
  plot = last_plot(),
  device = NULL,
  scale = 1,
  width = 20,
